    ...
    <nav className="flex items-center w-full justify-center z-50 bg-[#1f20207d] backdrop-blur-md top-0 md:h-14 fixed">
      <div className="flex items-center justify-between xl:w-1000 lg:w-4/5 md:w-4/5">
        ...
        <ul className="lg:flex md:hidden py-2 gap-6">
          <li className="py-2">
            <a className="text-[#9f9d9d] text-sm no-underline hover:text-gray-300" href="#home">
              Inicio
            </a>
          </li>
          <li className="py-2">
            <a className="text-[#9f9d9d] text-sm no-underline hover:text-gray-300" href="#projects">
              Proyectos
            </a>
          </li>
          <li className="py-2">
            <a className="text-[#9f9d9d] text-sm no-underline hover:text-gray-300" href="#about">
              Sobre mi
            </a>
          </li>
          <li className="py-2">
            <a className="text-[#9f9d9d] text-sm no-underline hover:text-gray-300" href="#certifications">
              Certificaciones
            </a>
          </li>
          <li className="py-2">
            <a className="text-[#9f9d9d] text-sm no-underline hover:text-gray-300" href="#skills">
              Skills
            </a>
          </li>
        </ul>
